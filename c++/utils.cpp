...
template RSDoublelinCameraPose outputSwitchDirection(const RSDoublelinCameraPose & in);
template RSSinglelinCameraPose outputSwitchDirection(const RSSinglelinCameraPose & in);
